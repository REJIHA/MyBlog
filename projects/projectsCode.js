...
function expandAnimation(thisOne) {
    let [elem, otherElem, elem_content, otherElem_content] = getWhichOne(thisOne);
...
function getWhichOne(theOne) {
    let elem, otherElem, elem_content, otherElem_content;
    ...
    return [elem, otherElem, elem_content, otherElem_content];
}